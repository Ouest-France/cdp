    ...
    def test_docker_usedocker_imagetagbranchname_useharborregistry_multi_build(self,mock_is_file):
        ...
        with patch("builtins.open", m):
          verif_cmd = [
            ...
            {'cmd': TestCliDriver.kaniko_multi_build % ("./distribution/php7-fpm","Dockerfile",TestCliDriver.cdp_harbor_registry + "/" + TestCliDriver.ci_project_name + "/" + TestCliDriver.ci_project_name + "/php",  TestCliDriver.ci_commit_ref_slug), 'output': 'unnecessary','docker_image': TestCliDriver.image_name_kaniko},
            {'cmd': 'hadolint ./distribution/nginx/Dockerfile', 'output': 'unnecessary', 'verif_raise_error': False},
            {'cmd': TestCliDriver.kaniko_multi_build % ("./distribution/nginx","Dockerfile",TestCliDriver.cdp_harbor_registry + "/" + TestCliDriver.ci_project_name + "/" + TestCliDriver.ci_project_name + "/nginx",  TestCliDriver.ci_commit_ref_slug), 'output': 'unnecessary','docker_image': TestCliDriver.image_name_kaniko},
          ]
